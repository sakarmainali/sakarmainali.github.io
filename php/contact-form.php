...
$email = 'sakarmainali@outlook.com';
...
$messager = ( isset($_POST['email']) ) ? $_POST['email'] : 'Define email in php/contact-form.php line 29';
...
try {
	...
	$mail->Username = 'sakaubuntu@gmail.com';                    // SMTP username
	$mail->Password = 'mjrwngumlszoajwb';                              // SMTP password
